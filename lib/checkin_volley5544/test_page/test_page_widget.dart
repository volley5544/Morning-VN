            ...
            children: [
              FlutterFlowCalendar(
                ...
                onChange: (DateTimeRange? newSelectedDate) async {
                  ...
                  _model.dateRange = _model.calendarSelectedDay;
                  safeSetState(() {});
                  FFAppState()
                      .addToDateSelectedList(_model.calendarSelectedDay!.start);
                  safeSetState(() {});
                  safeSetState(() {});
                },
              ...
              Text(
                '${_model.dateRange?.start.toString()} - ${_model.dateRange?.end.toString()}',
                style: FlutterFlowTheme.of(context).bodyMedium.override(
                      fontFamily: 'Readex Pro',
                      letterSpacing: 0.0,
                    ),
