...
import 'approve_show_page5544_model.dart';
export 'approve_show_page5544_model.dart';
...
class ApproveShowPage5544Widget extends StatefulWidget {
  ...
  State<ApproveShowPage5544Widget> createState() =>
      _ApproveShowPage5544WidgetState();
}

class _ApproveShowPage5544WidgetState extends State<ApproveShowPage5544Widget>
    with TickerProviderStateMixin {
  late ApproveShowPage5544Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ApproveShowPage5544Model());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      _model.getAllLeave = await GetAllLeaveCopyCall.call(
        ...
        await showDialog(
          ...
          builder: (alertDialogContext) {
            return WebViewAware(
              child: AlertDialog(
                content: Text(
                    'พบข้อผิดพลาดConnection (${(_model.getAllLeave?.statusCode ?? 200).toString()})'),
                actions: [
                  TextButton(
      ...
      if (getJsonField(
        ...
        await showDialog(
          ...
          builder: (alertDialogContext) {
            return WebViewAware(
              child: AlertDialog(
                content: Text('${GetAllLeaveCopyCall.messageLayer1(
                  (_model.getAllLeave?.jsonBody ?? ''),
                )}'),
                actions: [
                  TextButton(
                    ...
                    child: Column(
                      ...
                      children: [
                        FlutterFlowDropDown<String>(
                          ...
                          optionLabels: [
                            FFLocalizations.of(context).getText(
                              'trzdbwqs' /* previous year */,
                            ),
                            FFLocalizations.of(context).getText(
                              'crd3k2n5' /* current year */,
                            ),
                            FFLocalizations.of(context).getText(
                              'i74y1w72' /* next year */,
                            )
                                                        ...
                                                        children: [
                                                          SelectionArea(
                                                            ...
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                              '6xpxw6lt' /* [11/11/2565-12/11/2565] */,
                                                            ),
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .bodyMedium
                                                        ...
                                                        children: [
                                                          SelectionArea(
                                                            ...
                                                            FFLocalizations.of(
                                                                    context)
                                                                .getText(
                                                              'bnm2cmtz' /* [11/11/2565-12/11/2565] */,
                                                            ),
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                                .bodyMedium
