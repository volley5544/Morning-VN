...
import 'leave_show_page5544_model.dart';
export 'leave_show_page5544_model.dart';
...
class LeaveShowPage5544Widget extends StatefulWidget {
  ...
  State<LeaveShowPage5544Widget> createState() =>
      _LeaveShowPage5544WidgetState();
}

class _LeaveShowPage5544WidgetState extends State<LeaveShowPage5544Widget>
    with TickerProviderStateMixin {
  late LeaveShowPage5544Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LeaveShowPage5544Model());
              ...
              appBar: AppBar(
                ...
                title: Text(
                  FFLocalizations.of(context).getText(
                    '49v59d6c' /* Approval request list */,
                  ),
                  ...
                  children: [
                    if (true)
                      FlutterFlowDropDown<String>(
                        ...
                        optionLabels: [
                          FFLocalizations.of(context).getText(
                            'dosdtmqg' /* previous year */,
                          ),
                          FFLocalizations.of(context).getText(
                            'jd4kkr6o' /* current year */,
                          ),
                          FFLocalizations.of(context).getText(
                            '2pnjypu2' /* next year */,
                          )
                        ...
                        hintText: FFLocalizations.of(context).getText(
                          'ytb6w97r' /* Please select the month you wa... */,
                        ),
                        icon: FaIcon(
                    ...
                    if (true)
                      FlutterFlowDropDown<String>(
                        ...
                        hintText: FFLocalizations.of(context).getText(
                          '5abwhlob' /* Please select the month you wa... */,
                        ),
                        icon: FaIcon(
                          FontAwesomeIcons.solidCalendarAlt,
                          size: 15.0,
                                                                    ...
                                                                    SelectionArea(
                                                                      ...
                                                                      '${getJsonField(
                                                                        _model
                                                                            .leaveHistoryList
                                                                            .elementAtOrNull(leaveItemIndex),
                                                                        r'''$.list_date[*].LEAVE_START_DATE''',
                                                                      ).toString()} - ${getJsonField(
                                                                        _model
                                                                            .leaveHistoryList
                                                                            .elementAtOrNull(leaveItemIndex),
                                                                        r'''$.list_date[*].LEAVE_END_DATE''',
                                                                      ).toString()}',
                                                                      style: FlutterFlowTheme.of(
                                                                              context)
                                                                          .bodyMedium
                                                                  ...
                                                                  children: [
                                                                    Align(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        onTap:
                                                                            () async {
                                                                          if (FFAppState().leaveDocImgPathListNew.length <=
                                                                              0) {
                                                                            await showDialog(
                                                                              context: context,
                                                                              builder: (alertDialogContext) {
                                                                          ...
                                                                          FFAppState().leaveDocImgPathList = functions
                                                                              .convertStringListToImgPathList(FFAppState().leaveDocImgPathListNew.toList())
                                                                              .toList()
                                                                              .cast<String>();
                                                                          safeSetState(
                                                                              () {});
