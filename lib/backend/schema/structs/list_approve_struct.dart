...
class ListApproveStruct extends FFFirebaseStruct {
  ListApproveStruct({
    String? empCode,
    String? fullName,
    String? nickName,
  ...
  static ListApproveStruct fromMap(Map<String, dynamic> data) =>
      ListApproveStruct(
  ...
  static ListApproveStruct? maybeFromMap(dynamic data) => data is Map
      ? ListApproveStruct.fromMap(data.cast<String, dynamic>())
      : null;
  ...
  static ListApproveStruct fromSerializableMap(Map<String, dynamic> data) =>
      ListApproveStruct(
  ...
  @override
  String toString() => 'ListApproveStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    const listEquality = ListEquality();
    return other is ListApproveStruct &&
...
ListApproveStruct createListApproveStruct({
  String? empCode,
  String? fullName,
  String? nickName,
  String? companyName,
...
ListApproveStruct? updateListApproveStruct(
  ListApproveStruct? listApprove, {
  bool clearUnsetFields = true,
  bool create = false,
}) =>
    listApprove
...
void addListApproveStructData(
  ...
  if (listApprove.firestoreUtilData.delete) {
    firestoreData[fieldName] = FieldValue.delete();
    return;
  }
  final clearFields =
      !forFieldValue && listApprove.firestoreUtilData.clearUnsetFields;
  if (clearFields) {
    firestoreData[fieldName] = <String, dynamic>{};
  }
  final listApproveData =
      getListApproveFirestoreData(listApprove, forFieldValue);
  final nestedData =
      listApproveData.map((k, v) => MapEntry('$fieldName.$k', v));

  final mergeFields = listApprove.firestoreUtilData.create || clearFields;
  firestoreData
      .addAll(mergeFields ? mergeNestedFields(nestedData) : nestedData);
}

Map<String, dynamic> getListApproveFirestoreData(
  ListApproveStruct? listApprove, [
  bool forFieldValue = false,
]) {
  if (listApprove == null) {
...
List<Map<String, dynamic>> getListApproveListFirestoreData(
  List<ListApproveStruct>? listApproves,
) =>
    listApproves?.map((e) => getListApproveFirestoreData(e, true)).toList() ??
    [];
