...
import 'save_call_collection_page_model.dart';
export 'save_call_collection_page_model.dart';

class SaveCallCollectionPageWidget extends StatefulWidget {
  const SaveCallCollectionPageWidget({
    super.key,
    this.contNoSelected,
  });

  final List<CollectionDataModelStruct>? contNoSelected;

  static String routeName = 'SaveCallCollectionPage';
  static String routePath = '/saveCallCollectionPage';

  @override
  State<SaveCallCollectionPageWidget> createState() =>
      _SaveCallCollectionPageWidgetState();
}

class _SaveCallCollectionPageWidgetState
    extends State<SaveCallCollectionPageWidget> with TickerProviderStateMixin {
  late SaveCallCollectionPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SaveCallCollectionPageModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      _model.vloanGroup = CollectionVNGroup.getVloanDataCall
          .data(
            (_model.apiResulte17?.jsonBody ?? ''),
          )!
          .toList()
                                        ...
                                        child: Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  8.0, 0.0, 0.0, 0.0),
                                          child: Text(
                                            '${widget.contNoSelected?.firstOrNull?.name1} ${widget.contNoSelected?.firstOrNull?.name2}',
                                                                    ...
                                                                    child: Row(
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Padding(
                                                                          ...
                                                                          child:
                                                                              Text(
                                                                            functions.checkNullValueAndReturn(listCardItem.contno) == '-'
                                                                                ? '-'
                                                                                : listCardItem.contno,
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          Padding(
                                                                            ...
                                                                            child:
                                                                                Text(
                                                                              '${listCardItem.dateofexp} (งวด ${listCardItem.expDay})',
                                                                              style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                    font: GoogleFonts.readexPro(
                                                                                      fontWeight: FontWeight.normal,
                                                                                      fontStyle: FlutterFlowTheme.of(context).bodyMedium.fontStyle,
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Padding(
                                                                              ...
                                                                              child: Text(
                                                                                '${functions.showNumberWithComma('${listCardItem.sumCurrentdueamt}')} บาท',
                                                                                style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                      font: GoogleFonts.readexPro(
                                                                                        fontWeight: FontWeight.normal,
                                                                                        fontStyle: FlutterFlowTheme.of(context).bodyMedium.fontStyle,
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Padding(
                                                                              padding: EdgeInsetsDirectional.fromSTEB(5.0, 0.0, 0.0, 0.0),
                                                                              child: Text(
                                                                                '${functions.showNumberWithComma('${listCardItem.historyCount}')} ครั้ง',
                                                                                style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                      font: GoogleFonts.readexPro(
                                                                                        fontWeight: FontWeight.normal,
                                                                                        fontStyle: FlutterFlowTheme.of(context).bodyMedium.fontStyle,
                                                          ...
                                                          return wrapWithModel(
                                                            ...
                                                            updateCallback: () =>
                                                                safeSetState(
                                                                    () {}),
                                                            child:
                                                                InputAmountPPComponentWidget(
                                                              key: Key(
                                                                'Keyb0w_${contNoItemListItem.contno}',
                                                              ),
                                                              textBody:
                                                                  contNoItemListItem
                                                                      .contno,
