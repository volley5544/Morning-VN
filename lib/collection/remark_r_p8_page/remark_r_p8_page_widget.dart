...
import 'remark_r_p8_page_model.dart';
export 'remark_r_p8_page_model.dart';

class RemarkRP8PageWidget extends StatefulWidget {
  const RemarkRP8PageWidget({
    super.key,
    required this.contNoSelected,
  });

  final CollectionDataModelStruct? contNoSelected;

  static String routeName = 'RemarkRP8Page';
  static String routePath = '/remarkRP8Page';

  @override
  State<RemarkRP8PageWidget> createState() => _RemarkRP8PageWidgetState();
}

class _RemarkRP8PageWidgetState extends State<RemarkRP8PageWidget>
    with TickerProviderStateMixin {
  late RemarkRP8PageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RemarkRP8PageModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      _model.getRemarkDropdownOutput =
          await CollectionVNGroup.getRemarkRPDropdownApiCall.call(
        url: FFAppState().apiUrlVnCollection,
        language: FFLocalizations.of(context).languageCode,
        token: FFAppState().accessToken,
      );

      if ((_model.getRemarkDropdownOutput?.statusCode ?? 200) != 200) {
                                      ...
                                      Container(
                                        ...
                                        child: TextFormField(
                                          ...
                                          decoration: InputDecoration(
                                            ...
                                            hintText: currentUserLocationValue
                                                ?.toString(),
                            ...
                            child: Wrap(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Builder(
                                    builder: (context) {
                                      final uploadedImg = _model.imageList
                                          .toList()
                                          .take(5)
                                          .toList();
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: InkWell(
                                                      ...
                                                      onTap: () async {
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        content:
                                                                          ...
                                                                          if (FFLocalizations.of(context).languageCode ==
                                                                              'th') {
                                                                            return 'คุณต้องการจะลบรูปหรือไม่?';
                                                        ...
                                                        _model.removeAtIndexFromImageList(
                                                            uploadedImgIndex);
                                                        safeSetState(() {});
                                                      },
                                                      child: Icon(
                                ...
                                builder: (context) => FFButtonWidget(
                                  onPressed: () async {
                                            ...
                                            child: AlertDialog(
                                              content: Text(() {
                                                if (FFLocalizations.of(context)
                                                        .languageCode ==
                                                    'th') {
                                                  return 'กรุณาเลือกผลการติดตามหนี้';
                                    ...
                                    _model.saveCollectionApiOutput =
                                      ...
                                      customerName:
                                          '${widget.contNoSelected?.name1} ${widget.contNoSelected?.name2}',
                                      contNo: widget.contNoSelected?.contno,
                                      vLoanServer:
                                          widget.contNoSelected?.dbname,
                                      urlImgList: _model.imageUrlList,
                                      branchName:
                                    ...
                                    _shouldSetState = true;
                                    if ((_model.saveCollectionApiOutput
                                                ?.statusCode ??
                                            200) !=
                                        200) {
                                      await showDialog(
                                        ...
                                        builder: (alertDialogContext) {
                                          return WebViewAware(
                                            child: AlertDialog(
                                              content: Text(
                                                  'พบข้อผิดพลาด Connection(${(_model.saveCollectionApiOutput?.statusCode ?? 200).toString()})'),
                                              actions: [
                                                TextButton(
                                                  onPressed: () =>
                                                      Navigator.pop(
