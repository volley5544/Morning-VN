...
class _SuperAppPageWidgetState extends State<SuperAppPageWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      _model.roleMenuJson = await actions.getDataFromCollection(
        'role_menu',
      );
      FFAppState().roleMenuJson = _model.roleMenuJson!;
      safeSetState(() {});
                                            ...
                                            child: Align(
                                              ...
                                              child: Text(
                                                '${FFLocalizations.of(context).getVariableText(
                                                  ...
                                                  viText: 'Xin chào bạn',
                                                  thText: 'สวัสดีคุณ',
                                                )}${FFAppState().username != '' ? functions.greetingTextSuperApp(FFAppState().username) : ''}',
                                                    ...
                                                    child: Padding(
                                                      ...
                                                      child: FutureBuilder<
                                                        ...
                                                        builder: (context,
                                                          ...
                                                          List<ToolsMenuRecord>
                                                              gridViewToolsMenuRecordList =
                                                              snapshot.data!;
                                                          ...
                                                          return GridView
                                                            ...
                                                            itemBuilder: (context,
                                                                gridViewIndex) {
                                                              final gridViewToolsMenuRecord =
                                                                  gridViewToolsMenuRecordList[
                                                                      gridViewIndex];
                                                              return Visibility(
                                                                visible: functions.getSpecificIndexFromJson(
                                                                        FFAppState()
                                                                            .roleMenuJson,
                                                                        'Check in-out',
                                                                        FFAppState()
                                                                ...
                                                                child: InkWell(
                                                                  ...
                                                                  onTap:
                                                                    ...
                                                                    HapticFeedback
                                                                        .mediumImpact();
                                                                    if (gridViewToolsMenuRecord
                                                                            .openType ==
                                                                        'launch_url') {
                                                                      await launchURL(
                                                                          '${gridViewToolsMenuRecord.linkUrl}${() {
                                                                        if (gridViewToolsMenuRecord.paramType ==
                                                                            'no') {
                                                                          return '';
                                                                        } else if (gridViewToolsMenuRecord.paramType ==
                                                                            'token') {
                                                                          ...
                                                                          return '/${FFAppState().employeeID}';
                                                                            ...
                                                                            'branch_code') {
                                                                          return '/${FFAppState().profileBranchCode}';
                                                                        } else {
                                                                          return '';
                                                                        }
                                                                      }()}');
                                                                    } else if (gridViewToolsMenuRecord
                                                                            .openType ==
                                                                        'in_app_browser') {
                                                                      await actions
                                                                          .openTableauBrowser(
                                                                        ...
                                                                        Text(
                                                                          () {
                                                                            if (FFLocalizations.of(context).languageCode ==
                                                                                'en') {
                                                                              return gridViewToolsMenuRecord.name;
                                                                            } else if (FFLocalizations.of(context).languageCode ==
                                                                                'vi') {
                                                                              return gridViewToolsMenuRecord.nameVn;
                                                                            } else if (FFLocalizations.of(context).languageCode ==
                                                                                'th') {
                                                                              return gridViewToolsMenuRecord.nameTh;
                                                                            } else {
                                                                              return gridViewToolsMenuRecord.name;
                                                                            }
                                                                          }(),
