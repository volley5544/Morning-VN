                              ...
                              context.pushNamed(
                                ...
                                queryParameters: {
                                  'leaveName': serializeParam(
                                    listLeaveDataItemItem.name,
                                    ParamType.String,
                                  ),
                                  'leaveType': serializeParam(
                                    listLeaveDataItemItem.leaveType,
                                    ParamType.String,
                                  ),
                                  'startDateLeave': serializeParam(
                                    listLeaveDataItemItem.startDate,
                                    ParamType.String,
                                  ),
                                  'endDateLeave': serializeParam(
                                    listLeaveDataItemItem.endDate,
                                    ParamType.String,
                                  ),
                                  'currentYear': serializeParam(
                                    listLeaveDataItemItem.currentYear.year,
                                    ParamType.String,
                                  ),
                                  'nextYear': serializeParam(
                                    listLeaveDataItemItem.otherYear.year,
                                    ParamType.String,
                                  ),
                                  'currentYearSelectableDates': serializeParam(
                                    listLeaveDataItemItem
                                        .currentYear.leaveRemain,
                                    ParamType.String,
                                  ),
