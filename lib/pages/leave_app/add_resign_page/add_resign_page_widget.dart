        ...
        appBar: AppBar(
          ...
          title: Text(
            FFLocalizations.of(context).getText(
              'ui4tf8f1' /* ยื่นเรื่องขออนุมัติลาออก */,
            ),
                                ...
                                children: [
                                  Align(
                                    ...
                                    child: SelectionArea(
                                        child: Text(
                                      FFLocalizations.of(context).getText(
                                        'b04k4nfv' /* วันที่ทำงานวันสุดท้าย  : */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                ...
                                children: [
                                  Align(
                                    ...
                                    child: SelectionArea(
                                        child: Text(
                                      FFLocalizations.of(context).getText(
                                        'ojtl5sgg' /* เหตุผลที่ตัดสินใจลาออก (ระบุได... */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                ...
                                children: [
                                  Align(
                                    ...
                                    child: SelectionArea(
                                        child: Text(
                                      FFLocalizations.of(context).getText(
                                        '5dois0z1' /* อยากให้บริษัทปรับปรุงการทำงานด... */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                ...
                                children: [
                                  Align(
                                    ...
                                    child: SelectionArea(
                                        child: Text(
                                      FFLocalizations.of(context).getText(
                                        '8hqyjbe0' /* ในช่วงที่แจ้งลาออก สามารถติดต่... */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                ...
                                children: [
                                  Expanded(
                                    child: FlutterFlowDropDown<String>(
                                      ...
                                      hintText:
                                          FFLocalizations.of(context).getText(
                                        'pei96fxr' /* กรุณาเลือกรหัสไปรษณีย์... */,
                                      ),
                                      fillColor: Colors.white,
                                      elevation: 2.0,
                                      borderColor: Colors.transparent,
                                ...
                                children: [
                                  Align(
                                    ...
                                    child: SelectionArea(
                                        child: Text(
                                      FFLocalizations.of(context).getText(
                                        'hlwgphwz' /* หากมีโอกาสจะกลับมาร่วมงานกับบร... */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                ...
                                children: [
                                  Align(
                                    ...
                                    child: SelectionArea(
                                        child: Text(
                                      FFLocalizations.of(context).getText(
                                        '4o4btaer' /* ทรัพย์สินของบริษัทที่ต้องส่งคื... */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                ...
                                children: [
                                  Expanded(
                                    child: TextFormField(
                                      ...
                                      focusNode:
                                          _model.returnAssetTextFieldFocusNode,
                                      autofocus: false,
                                      obscureText: false,
                                      decoration: InputDecoration(
                                        hintText:
