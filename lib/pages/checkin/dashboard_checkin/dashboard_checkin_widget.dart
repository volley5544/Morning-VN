...
class _DashboardCheckinWidgetState extends State<DashboardCheckinWidget>
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<ChgLocationPermRecord>>(
      stream: queryChgLocationPermRecord(
        singleRecord: true,
      ),
      builder: (context, snapshot) {
        ...
        List<ChgLocationPermRecord> dashboardCheckinChgLocationPermRecordList =
            snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final dashboardCheckinChgLocationPermRecord =
            dashboardCheckinChgLocationPermRecordList.isNotEmpty
                ? dashboardCheckinChgLocationPermRecordList.first
                : null;
                          ...
                          await showDialog(
                            ...
                            builder: (alertDialogContext) {
                              return WebViewAware(
                                child: AlertDialog(
                                  content: Text(
                                      dashboardCheckinChgLocationPermRecord!
                                          .empId.length
                                          .toString()),
                                  actions: [
                                    TextButton(
                          ...
                          await showDialog(
                            ...
                            builder: (alertDialogContext) {
                              return WebViewAware(
                                child: AlertDialog(
                                  content: Text(
                                      (functions.checkChangLocationFunction(
                                                  dashboardCheckinChgLocationPermRecord
                                                      ?.empId
                                                      .toList(),
                    ...
                    child: Padding(
                      ...
                      child: Wrap(
                        ...
                        children: [
                          ...
                          if (functions.checkChangLocationFunction(
                                  dashboardCheckinChgLocationPermRecord?.empId
                                      .toList(),
                                  FFAppState().employeeID) ==
                              true)
                            InkWell(
