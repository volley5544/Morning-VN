                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          ...
                          if (selectedMedia != null &&
                            ...
                            safeSetState(() => _model
                                    .isDataUploading_uploadCheckinImageAction =
                                true);
                                    ...
                                    children: [
                                      Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          highlightColor: Colors.transparent,
                                          onTap: () async {
                                            if (_model.listLocationData.length >
                                                10) {
                                ...
                                child: Container(
                                  ...
                                  child: custom_widgets.DrawCircleMap(
                                    ...
                                    height: MediaQuery.sizeOf(context).height *
                                        0.25,
                                    latitude: _model.dropDownBranchValue !=
                                                null &&
                                            _model.dropDownBranchValue != ''
                                        ...
                                        : 0.0,
                                    longitude: _model.dropDownBranchValue !=
                                                null &&
                                            _model.dropDownBranchValue != ''
                                        ? valueOrDefault<double>(
                                            double.parse(_model.listLocationData
                                        ...
                                        : 0.0,
                                    radiusLo: _model.dropDownBranchValue !=
                                                null &&
                                            _model.dropDownBranchValue != ''
                                        ? valueOrDefault<double>(
                                            double.parse(_model.listLocationData
